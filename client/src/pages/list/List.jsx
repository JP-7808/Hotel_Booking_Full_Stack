...
const List = () => {
  ...
  const { data, loading, error, reFetch } = useFetch(
    `https://hotel-booking-backend-3j5l.onrender.com/api/hotels?city=${destination}&min=${min || 0 }&max=${max || 999}`
  );
          ...
          <div className="listSearch">
            ...
            <div className="lsItem">
              ...
              <span onClick={() => setOpenDate(!openDate)}>
                {dates.length > 0 && `${format(dates[0].startDate, "MM/dd/yyyy")} to ${format(dates[0].endDate, "MM/dd/yyyy")}`}
              </span>
              {openDate && (
                <DateRange
